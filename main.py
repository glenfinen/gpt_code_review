...
def make_prompt(dev_lang: str) -> str:
    ...
    Your review should include sections for potential bugs, code smell, security issues, inconsistent formatting, readability issues and should suggest improvements but only if there are major issues.
